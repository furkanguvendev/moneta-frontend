...
export const Landing: React.FC = () => {
  ...
  const addToRefs = useCallback((node: HTMLElement | null) => {
    if (node) {
      sectionsRef.current.set(node.id, node);
    }
  }, []);
  ...
  return (
    <div className="landing-container min-h-screen bg-[#04110d] text-slate-100 selection:bg-emerald-500 selection:text-zinc-950">
      ...
      <header className="landing-header sticky top-0 z-50 backdrop-blur-md bg-[#04110d]/80 border-b border-white/5 px-6 py-4 flex justify-between items-center">
        ...
        <nav className="landing-nav hidden md:flex items-center gap-6 text-xs lg:text-sm font-medium text-slate-400">
      ...
      <main className="landing-main">
        ...
        {/* HERO SECTION */}
        <section id="hero" className="landing-section-hero min-h-[calc(100vh-73px)] px-6 py-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 w-full max-w-2xl flex items-center justify-center mt-12 lg:mt-0">
            <img 
              ...
              alt="Moneta Dashboard" 
              className="w-full h-auto rounded-2xl shadow-2xl border border-white/10 object-cover shadow-emerald-500/5" 
            />
          </div>
        </section>

        {/* FEATURES SECTION */}
        <section id="features" ref={addToRefs} className="landing-section-standard reveal-section px-6 py-20 max-w-7xl mx-auto scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
            <div className="landing-card bg-emerald-950/20 border border-emerald-950/50 p-6 rounded-3xl flex flex-col hover:border-emerald-500/30 transition-all">
              <div className="landing-card-icon-wrapper mb-4 p-3 bg-emerald-500/10 rounded-2xl w-fit border border-emerald-500/20">
        ...
        <section id="architecture" ref={addToRefs} className="landing-section-bg reveal-section px-6 py-20 max-w-7xl mx-auto scroll-mt-24">
          <div className="w-full flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="flex-1 w-full max-w-xl flex items-center justify-center mt-12 lg:mt-0">
              <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&auto=format&fit=crop&q=80" alt="Moneta Mimari Entegrasyon Şeması" className="w-full h-auto rounded-2xl border border-white/10 object-cover shadow-2xl" />
            </div>
          </div>
        </section>

        {/* ABOUT SECTION */}
        <section id="about" ref={addToRefs} className="w-full px-6 py-20 max-w-4xl mx-auto text-center flex flex-col items-center justify-center scroll-mt-24 reveal-section">
        ...
        {/* FAQ SECTION */}
        <section id="faq" ref={addToRefs} className="w-full px-6 py-20 lg:py-32 max-w-4xl mx-auto flex flex-col items-center justify-center scroll-mt-24 border-t border-white/10 reveal-section">
          ...
          <div className="flex flex-col gap-6 w-full">
            <div className="bg-emerald-950/20 border border-emerald-950/50 p-6 rounded-2xl text-left shadow-lg">
            ...
            <div className="bg-emerald-950/20 border border-emerald-950/50 p-6 rounded-2xl text-left shadow-lg">
              <h4 className="text-base lg:text-lg font-bold text-white mb-3">"Zorunlu Harcama" filtresi ne işe yaryor?</h4>
              <p className="text-xs lg:text-sm text-white/60 leading-relaxed">
      ...
      {/* FOOTER SECTION */}
      <footer className="w-full py-12 border-t border-white/10 text-center text-xs text-white/40 bg-[#020b08]">
